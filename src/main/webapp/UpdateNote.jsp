				...
				<form action="UpdateNoteServlet" method="post" >
					...
					<div class="mb-3">
						...
						<input name="title" type="text" class="form-control"
							id="exampleFormControlInput1" value="<%=note.getTitle() %>" required />
					</div>
					<div class="mb-5">
						<label for="exampleFormControlTextarea1" class="form-label">Note</label>
						<textarea name="content" style="height: 300px;" class="form-control" id="exampleFormControlTextarea1"
							rows="3" required ><%= note.getContent() %></textarea>
					</div>
					<div class="container align-center" >
						<button type="submit" class="btn btn-primary started">Update</button>
					</div>
				</form>
			</div>
		</div>
